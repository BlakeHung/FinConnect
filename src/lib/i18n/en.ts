const en = {
  ...
  transactions: {
    ...
    add_split_item: 'Add Split Item',
    no_split_items: 'No split items',
    payment_details: 'Payment Details',
    add_payment: 'Add Payment',
    no_payment_records: 'No payment records',
    select_group_for_split: 'Select a group to split',
    invalid_split_item: 'Invalid split item',
    split_amount_exceeds_total: 'Total split amount cannot exceed transaction amount',
    split_item_saved: 'Split item saved',
    member_totals: 'Member Totals',
    participants: 'Participants',
