const en = {
  ...
  transactions: {
    ...
    save_all: 'Save All',
    batch_created_success: 'Batch transactions created successfully',
    batch_created_error: 'Error creating batch transactions',
    validation_error: 'Please check all fields are filled correctly',
    transaction: 'Transaction',
    split_expense: 'Split Expense',
    split_explanation: 'After saving, you will enter the split settings page to select group members and split method',
    split_requires_group: 'Splitting requires selecting a group first',
    ...
    split_members_equal_desc: 'Select members to participate in splitting, expense will be divided equally',
    split_members_percentage_desc: 'Specify percentage for each member, total should be 100%',
    split_members_fixed_desc: 'Specify amount for each member, total should equal transaction amount',
    no_members_selected: 'Please select at least one member to split with',
    split_summary: 'Split Summary',
    split_equally_among: 'Split equally among {count} members',
    each_pays: 'Each pays {amount}',
    total_percentage: 'Total Percentage',
    total_amount: 'Total Amount',
    select_members_to_split: 'Please select members to split with',
    save_split: 'Save Split',
    percentage_error: 'Percentage total must be 100%',
    fixed_error: 'Fixed amount total must equal transaction amount',
    split_error: 'Failed to split expense',
    split_success: 'Split saved successfully',
    transaction_details: 'Transaction Details',
    error_loading_members: 'Failed to load group members',
