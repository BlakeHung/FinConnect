const zh = {
  ...
  transactions: {
    ...
    save_all: '保存全部',
    batch_created_success: '批量交易創建成功',
    batch_created_error: '創建批量交易時出錯',
    validation_error: '請檢查所有字段是否正確填寫',
    transaction: '交易',
    split_expense: '分帳',
    split_explanation: '儲存後將進入分帳設定頁面，選擇群組成員和分帳方式',
    split_requires_group: '分帳功能需先選擇群組',
    split_settings: '分帳設置',
    split_method: '分帳方式',
    split_methods: {
      equal: '平均分配',
    ...
    distribute_equally: '平均分配數值',
    split_members: '分帳成員',
    split_members_equal_desc: '選擇參與分帳的成員，費用將平均分配',
    split_members_percentage_desc: '指定每個成員的分帳百分比，總和應為 100%',
    split_members_fixed_desc: '指定每個成員的分帳金額，總和應等於交易金額',
    no_members_selected: '請至少選擇一個成員進行分帳',
    split_summary: '分帳摘要',
    split_equally_among: '平均分配給 {count} 位成員',
    each_pays: '每人支付 {amount}',
    total_percentage: '總百分比',
    total_amount: '總金額',
    select_members_to_split: '請選擇要分帳的成員',
    save_split: '儲存分帳設定',
    percentage_error: '百分比總和必須為 100%',
    fixed_error: '固定金額總和必須等於交易金額',
    split_error: '分帳失敗',
    split_success: '分帳成功',
    transaction_details: '交易詳情',
    error_loading_members: '載入群組成員失敗',
